  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-white/80 dark:bg-[#0D0D0D] backdrop-blur border border-slate-200/40 dark:border-white/10 p-4 rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.01)] flex-shrink-0">
        ...
        <div className="flex bg-slate-100 dark:bg-black p-1 rounded-xl border border-slate-200/30 dark:border-white/10">
          {[
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="bg-white dark:bg-[#0D0D0D] p-4 rounded-xl border border-slate-200/50 dark:border-white/10 shadow-[0_2px_8px_rgba(0,0,0,0.01)] text-left">
          ...
          <div className="bg-white dark:bg-[#0D0D0D] border border-slate-200/50 dark:border-white/10 rounded-2xl overflow-hidden shadow-sm">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {landingPages.map(lp => (
              <div 
                key={lp.id} 
                className="bg-white dark:bg-[#0D0D0D] border border-slate-200/50 dark:border-white/10 p-5 rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.01)] flex flex-col justify-between h-48 text-left relative group hover:shadow-md transition-shadow"
              >
                <div>
                  <div className="flex justify-between items-start">
                    <span className="w-8 h-8 rounded-lg bg-slate-100 dark:bg-black flex items-center justify-center text-slate-400">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {forms.map(form => (
              <div 
                key={form.id} 
                className="bg-white dark:bg-[#0D0D0D] border border-slate-200/50 dark:border-white/10 p-5 rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.01)] text-left flex flex-col justify-between"
              >
                <div>
