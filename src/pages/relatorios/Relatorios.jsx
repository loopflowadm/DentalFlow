            ...
            {dentistRevenueData.length > 0 && dentistRevenueData.some(d => d.faturamento > 0) ? (
              ...
              <div className="flex flex-col items-center justify-center text-center p-6 space-y-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-slate-800 dark:bg-white/10 text-white rounded-xl text-xs font-bold hover:bg-slate-700 transition-colors shadow-sm cursor-pointer flex items-center gap-1.5"
                >
