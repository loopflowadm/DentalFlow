...
export default function Configuracoes() {
  ...
  return (
    <div className="h-full flex flex-col overflow-y-auto scrollbar-thin bg-slate-50/50 dark:bg-black font-body">
      ...
      <div className="flex flex-col md:flex-row items-center justify-start gap-3 bg-white dark:bg-[#0D0D0D] px-6 py-3 border-b border-slate-200/80 dark:border-white/5 flex-shrink-0 transition-colors duration-300">
